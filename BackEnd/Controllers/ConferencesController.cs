...
namespace BackEnd.Controllers
{
    ...
    public class ConferencesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ConferenceResponse>> CreateConference(EventDTO.Conference input)
        {
            ...
            var result = new EventDTO.ConferenceResponse
            {
                ID = conference.ID,
                Name = conference.Name
            };
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> PutConference(int id, EventDTO.Conference input)
        {
            var conference = await _db.FindAsync<Data.Conference>(id);
